...
const VerificationModal = ({ email, handleVerificationSuccess, handleVerificationClose }) => {
  ...
  const handleVerification = async (e) => {
    ...
    try {
      const response = await fetch('https://pesd-3.onrender.com/api/auth/verify-email', {
        method: 'POST',
        headers: {
  ...
  const handleResendCode = async () => {
    ...
    try {
      const response = await fetch('https://pesd-3.onrender.com/api/auth/resend-verification-code', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
